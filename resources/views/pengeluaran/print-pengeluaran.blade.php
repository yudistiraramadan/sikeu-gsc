...
<body>
    <table border="0" align="center" width="90%">
        ...
        <tr>
            ...
            <td colspan="2" style="font-family: Arial, Helvetica, sans-serif">Yudistira Ramadan Kalimasada</td>
        </tr>
        <tr>
            <td colspan="2" height="30px" style="font-family: Arial, Helvetica, sans-serif">Alamat</td>
            <td style="text-align: center">:</td>
            <td colspan="2" style="font-family: Arial, Helvetica, sans-serif">Jalan Dahlia Gang 2 No 70.A RT 03 RW 12
            </td>
        </tr>
        <tr>
            <td colspan="2" height="30px" style="font-family: Arial, Helvetica, sans-serif">Uang Sebanyak</td>
            <td style="text-align: center">:</td>
            <td colspan="2" style="font-family: Arial, Helvetica, sans-serif">Rp. 500.000
            </td>
        </tr>
        <tr>
            <td colspan="2" height="30px" style="font-family: Arial, Helvetica, sans-serif">Terbilang</td>
            <td style="text-align: center">:</td>
            <td colspan="2" style="font-family: Arial, Helvetica, sans-serif">LIMA RATUS RIBU RUPIAH</td>
        </tr>
        <tr>
            <td colspan="2" height="30px" style="font-family: Arial, Helvetica, sans-serif">Keterangan</td>
            <td style="text-align: center">:</td>
            <td colspan="2" style="font-family: Arial, Helvetica, sans-serif">Pentasyarufan Dhuafa</td>
        </tr>
        <tr>
            <td colspan="5">
                <hr />
