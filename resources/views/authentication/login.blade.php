...
<main class="form-signin w-100 m-auto">
  <form action="{{ route('postlogin') }}" method="POST">
    ...
    <br>
    <h1 class="h3 mb-3 fw-normal" style="color: #1c5866; font-family:nunito;"><b>Sistem Informasi Keuangan GSC</b></h1>
    ...
    <button class="w-100 btn btn-lg" style="background-color: #2b8fa6; color:#ffffff;" type="submit">Masuk</button>
